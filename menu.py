...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Please select the menu item you would like to order: ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    item_qty = input(f"How many {item_name} would you like to order: ")
                    ...
                    # Referring to 4. check if the menu selection is in the menu items
                    print(f"Your selection is not valid on the menu")

            else:
                # Tell the customer they didn't select a menu option
                # Referring to 3. Check if the customer typed a number
                print(f"Your selection is not a number")
